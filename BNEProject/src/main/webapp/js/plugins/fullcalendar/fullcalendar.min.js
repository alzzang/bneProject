...
(function(t) {
    ...
    t.extend(re.prototype, {
        ...
        renderSegHtml: function(t, e) {
            var i, n, r, o = this.view, s = t.event, l = o.isEventDraggable(s), a = !e && true && o.isEventResizable(s), c = this.getSegClasses(t, l, a), d = this.getEventSkinCss(s);
            var returnvalue1 = c.unshift("fc-time-grid-event");
/*            o.isMultiDayEvent(s) ? (t.isStart || t.isEnd) && (i = o.getEventTimeText(t.start, t.end),
            		...
            		if(t.isEnd != true){
            			...
            			c[4] = 'fc-resizable';
            			s.end._d.setHours(3);
            			s.end._d.setMinutes(0);	
            		}
            		if(t.isStart != true){
            			c[2] = 'fc-start';
            			s.start._d.setHours(18);
            			s.start._d.setMinutes(0);
            		}
            		i = o.getEventTimeText(s),
                    n = o.getEventTimeText(s, "LT"),
                    r = o.getEventTimeText(s.start, null )/*)*/;
                    var endtime = o.getEventTimeText(s.end,null);
                    
                    var temp1 = r.split(":");
                    var temp2 = endtime.split(":");
                    var hour = temp2[0] - temp1[0];
                    var minute = temp2[1] - temp1[1];
                    if(minute <0){
                    	hour = hour-1;
                    	minute = 30;
                    }
          ...
          //  var returnvalue2 = 
            ...
            n = o.getEventTimeText(s, "LT"),
            r = o.getEventTimeText(s.start, null )),
            '<a  id = "a" class="' + c.join(" ") + '"' + (s.url ? ' href="' + R(s.url) + '"' : "") + (d ? ' style="' + d + '"' : "") + ">" + '<div class="fc-content">' + (i ? '<div class="fc-time" data-start="' + R(r) + '"' + ' data-full="' + R(n) + '"' + ">" + "<span>" + R(i) + "</span>" + "</div>" : "") + (s.title ? '<div class="fc-title">' + R(s.title) + "</div>" : "") + "</div>" + '<div class="fc-bg"/>' + (a ? '<div class="fc-resizer"/>' : "") + "</a>"
        },
