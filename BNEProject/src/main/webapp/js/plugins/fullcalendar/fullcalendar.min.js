...
(function(t) {
    ...
    function l(i, n) {
        ...
        function f(e, i) {
            ...
            re = null ),
            !re && i && (re = new xe[i](q),
            re.el = t("<div class='fc-view fc-" + i + "-view' id = 'test1'/>").appendTo(ie),
            te.activateButton(i)),
            ...
            for (r = 0; g > r; r++) {
                ...
                o)
                    ...
                    for (a = 0; o.length > a; a++) {
                        for (c = o[a],
                        n(c.leftCol),
                        c.el.append('<ul class = "fc-panel-controls"><li><a href="#" class="fc-panel-remove"><span class="glyphicon glyphicon-remove"></span></a><li></ul>'),
                        d = t('<td class="fc-event-container" id ='+dayArr[s]+'/>').append(c.el),
    ...
    t.extend(re.prototype, {
        ...
        renderEventTable: function(e) {
            ...
            o = 0; i.length > o; o++) {
                for (s = i[o],
                oe(s),
                l = t('<div class="fc-event-container" id ='+dayArr[o]+'/>'),
                n = 0; s.length > n; n++)
                    r = s[n],
