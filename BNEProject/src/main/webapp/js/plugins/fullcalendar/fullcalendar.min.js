...
/*            	alert("n");*/
            ...
            e && o && !this.isHidden) /*? null(this.isAnimating = !0,
            this.el.animate({
                top: this.top0,
                left: this.left0
            }, {
...
*/            return e && r.push("fc-draggable"),
    ...
    t.extend(re.prototype, {
        ...
        renderSegHtml: function(t, e) {
            ...
            splitTemp = s.start._i.split(" "),
            day = splitTemp[0],
            startTime = splitTemp[1],
          	splitTemp = s.end._i.split(" "),
            endTime = splitTemp = splitTemp[1],
            '<a date = "'+day+'" startTime="'+startTime+'" endTime="'+endTime+'"class="' + c.join(" ") + '"' + (s.url ? ' href="' + R(s.url) + '"' : "") + (d ? ' style="' + d + '"' : "") + ">" + '<div class="fc-content">' + (i ? '<div class="fc-time" data-start="' + R(r) + '"' + ' data-full="' + R(n) + '"' + ">" + "<span>" + R(i) + "</span>" + "</div>" : "") + (s.title ? '<div class="fc-title">' + R(s.title) + "</div>" : "") + "</div>" + '<div class="fc-bg"/>' + (a ? '<div class="fc-resizer"/>' : "") + "</a>"
        },
