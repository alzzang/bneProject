...
(function(t) {
    ...
    function l(i, n) {
        ...
        function f(e, i) {
            ...
            re = null );
            !re && i && (re = new xe[i](q),
            re.el = t("<div class='fc-view fc-" + i + "-view' id = 'trash'/>").appendTo(ie),
            te.activateButton(i));
            le = re.incrementDate(le,e);
            re && (e && le,
...
/* alert("n"); */
            ...
            e && o && !this.isHidden) /*
										 * ? null(this.isAnimating = !0,
										 * this.el.animate({ top: this.top0,
    ...
    t.extend(J.prototype, {
        ...
        headHtml: function() {
            return '<div class="fc-row ' + this.view.widgetHeaderClass + '">' + '<table id="weeklyTableHeader">' + "<thead>" +  this.rowHtml("head") +"</thead>" + "<tbody></tbody>" + "</table>" + "</div>";
        },
        ...
        headCellHtml: function(t, e, i) {
            ...
            return '<th class="fc-day-header ' + n.widgetHeaderClass + " fc-" + Re[i.day()] + '" data-date="' + i.format() + '">' + R(r.formatDate(i, o)) + "</th>"
        },
 ...
 */            return e && r.push("fc-draggable"),
    ...
    t.extend(ee.prototype, {
        ...
        renderSegHtml: function(t, e) {
            ...
            var date, month, year;
            date = t.event.start._d.getDate();
            month = t.event.start._d.getMonth();
            year = t.event.start._d.getYear();
            ...
            '<a class="' + a.join(" ") + '" date = "'+date+'" ' + (o.url ? ' href="' + R(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + "id='test'>" + '<div class="fc-content">' + (r ? i + " " + d : d + " " + i) + "</div>" + (l ? '<div class="fc-resizer"/>' : "") + "</a>"
        },
        renderEventRow: function(e, i) {
            ...
            date = h.start._d.getDate();
            month = h.start._d.getMonth();
            year = h.start._d.getYear();
            ...
            for (r = 0; g > r; r++) {
                ...
                o)
                    for (a = 0; o.length > a; a++) {
                        for (c = o[a],
                        n(c.leftCol),
                        c.el.append('<ul class = "fc-panel-controls"></ul>'),
                        day = ((year+1900)+":"+(month+1)+":"+(date+s)+":"+dayArr[s]),
                        d = t('<td class="fc-event-container" date ='+day+'/>').append(c.el),
    ...
    t.extend(re.prototype, {
        ...
        renderEventTable: function(e) {
            ...
            o = 0; i.length > o; o++) {
                for (s = i[o],
                oe(s),
                day  = ((year+1900)+":"+(month+1)+":"+(date+o)+":"+dayArr[o]),
                l = t('<div class="fc-event-container" date ='+day+'/>'),
                n = 0; s.length > n; n++)
                    r = s[n],
                    r.el.css(this.generateSegPositionCss(r)),
                    30 > r.bottom - r.top && r.el.addClass("fc-short"),
                    r.el.append('<ul class = "fc-panel-controls"><li><a href="#" class="fc-panel-remove"><span class="glyphicon glyphicon-remove"></span></a><li></ul>'),
                    l.append(r.el);
        ...
        renderSegHtml: function(t, e) {
            ...
            var i, n, r,day, o = this.view, s = t.event, l = o.isEventDraggable(s), a = !e && t.isEnd && o.isEventResizable(s), c = this.getSegClasses(t, l, a), d = this.getEventSkinCss(s);
    ...
    t.extend(Ee.prototype, {
        ...
        renderHtml: function() {
            return '<table><thead><tr><td class="' + this.widgetHeaderClass + '">' + this.timeGrid.headHtml() + "</td>" + "</tr>" + "</thead>" + "<tbody>" + "<tr>" + '<td class="' + this.widgetContentClass + '">' + (this.dayGrid ? '<div class="fc-day-grid"/><hr class="' + this.widgetHeaderClass + '"/>' : "") + '<div class="fc-time-grid-container" style="height:380px;">' + '<div class="fc-time-grid"/>' + "</div>" + "</td>" + "</tr>" + "</tbody>" + "</table>"
        },
        headIntroHtml: function() {
            var t, e, i, n;
        ...
        setHeight: function(t, e) {
/*
 * var i, n; null === this.bottomRuleHeight && (this.bottomRuleHeight =
 * this.bottomRuleEl.outerHeight()), this.bottomRuleEl.hide(),
 * this.scrollerEl.css("overflow", ""), v(this.scrollerEl),
 * u(this.noScrollRowEls), this.dayGrid && (this.dayGrid.destroySegPopover(), i =
 * this.opt("eventLimit"), i && "number" != typeof i && (i = Ye), i &&
 * this.dayGrid.limitRows(i)), e || (n = this.computeScrollerHeight(t),
 * m(this.scrollerEl, n) ? (h(this.noScrollRowEls, w(this.scrollerEl)), n =
 * this.computeScrollerHeight(t), this.scrollerEl.height(n),
