            ...
            b = function(a) {
                ...
                b.prototype.defaultOptions = {
                    ...
                    fallback: function() {
                        ...
                        f = g.length; f > e; e++)
                            a = g[e],
                            /(^| )dz-message($| )/.test(a.className) && (c = a,
                    ...
                    addedfile: function(a) {
                        ...
                        this.previewsContainer) {
                            for (a.previewElement = b.createElement(this.options.previewTemplate.trim()),
                ...
                b.prototype.init = function() {
                    ...
                    this.clickableElements.length && (d = function(a) {
                        return function() {
                            ...
                            a.hiddenFileInput.setAttribute("name", "image"),
                ...
                b.prototype.getFallbackForm = function() {
                    ...
                    c = b.createElement(d),
                    "FORM" !== this.element.tagName ? (e = b.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>'),
             ...
             /*     var b;
                    return a >= 109951162777.6 ? (a /= 109951162777.6,
                    b = "TiB") : a >= 107374182.4 ? (a /= 107374182.4,
                    b = "GiB") : a >= 104857.6 ? (a /= 104857.6,
                    b = "MiB") : a >= 102.4 ? (a /= 102.4,
                    b = "KiB") : (a = 10 * a,
                    b = "b"),
                ...
                b.prototype.cancelUpload = function(a) {
                    ...
                    if (a.status === b.UPLOADING) {
                        ...
                        ((i = a.status) === b.ADDED || i === b.QUEUED) && (a.status = b.CANCELED,
                ...
                b.prototype.uploadFiles = function(a) {
                    ...
                    if (this.options.uploadMultiple && this.emit("sendingmultiple", a, t, e),
                    "FORM" === this.element.tagName)
                        for (F = this.element.querySelectorAll("input, textarea, select, button"),
                        w = 0,
                        A = F.length; A > w; w++)
                            if (k = F[w],
                            l = k.getAttribute("name"),
                            m = k.getAttribute("type"),
                            "SELECT" === k.tagName && k.hasAttribute("multiple"))
                                for (G = k.options,
                                x = 0,
                                B = G.length; B > x; x++)
                                    o = G[x],
                    ...
                    for (j = C = 0,
                    I = a.length - 1; I >= 0 ? I >= C : C >= I; j = I >= 0 ? ++C : --C)
                    
                    	if ( typeof a[j] != "undefined" ) {
                    		  e.append(this._getParamName(j), a[j], a[j].name);
                    		} else {
                    		  e.append(this._getParamName(j), "");
                    		} 
                ...
                b.prototype._finished = function(a, c, d) {
                    ...
                    return this.options.uploadMultiple && (this.emit("successmultiple", a, c, d),
                ...
                b.prototype._errorProcessing = function(a, c, d) {
                    ...
                    g = a.length; g > f; f++)
                        ...
                        this.emit("complete", e);
                    return this.options.uploadMultiple && (this.emit("errormultiple", a, c, d),
                    this.emit("completemultiple", a)),
                    this.options.autoProcessQueue ? this.processQueue() : void 0
                }
                ,
