...
nhn.husky.SE_EditingAreaManager = jindo.$Class({
    ...
    /*태우추가 스크립트*/    
    $ON_UPDATE_CONTENTSS_FIELD: function(b) {
    	this.elContentsField.value = b;
        this.oApp.exec("UPDATE_RAW_CONTENTSS")
    },
    ///////////////
    ...
    /*태우추가 스크립트*/    
    $ON_UPDATE_RAW_CONTENTSS: function(b) {
        this.sCurrentRawContents = b
    },
    ////////////////////
...
nhn.husky.SE_EditingArea_WYSIWYG = jindo.$Class({
    ...
    $init: function(b) {
        ...
        this.sBlankPageURL = "/dailyReport/inputarea";
    ...
    _getResizeHeight: function() {
        var d = this.getDocument().body, b, f, a = ["width", "fontFamily", "fontSize", "fontWeight", "fontStyle", "lineHeight", "letterSpacing", "textTransform", "wordSpacing"], e, c;
    ...
    _setBodyHeight: function() {
        ...
        var e = this.getDocument().body, l = jindo.$Element(e), g = parseInt(l.css("marginTop"), 10) + parseInt(l.css("marginBottom"), 10), f = this.oApp.getEditingAreaHeight(), d = f - g, a = l.height(), c, j;
    ...
    _pageUp: function(c) {
        var b = this._getEditorHeight(), d = jindo.$Document(this.oApp.getWYSIWYGDocument()).scrollPosition(), a;
        if (d.top <= b) {
            a = 0
        } else {
            a = d.top - b
    ...
    _pageDown: function(c) {
        var b = this._getEditorHeight(), d = jindo.$Document(this.oApp.getWYSIWYGDocument()).scrollPosition(), e = this._getBodyHeight(), a;
        if (d.top + b >= e) {
            a = e - b
        } else {
            a = d.top + b
    ...
    initIframe: function() {
        try {
            ...
            if (b) {
                ...
                a.type = "text/css";
                a.rel = "stylesheet";
                a.href = "/css/smart_editor2_in.css";
    ...
    setIR: function(h) {
        var c, b = this.oApp.oNavigator, d = b.ie && document.documentMode < 11, g = d ? "" : "<br>";
        if (this.oApp.applyConverter) {
...
nhn.husky.SE_WYSIWYGEnterKey = jindo.$Class({
    ...
    _wrapBlock: function(l, n) {
        var d = this.oApp.getSelection(), k = d.placeStringBookmark(), p = d.getLineInfo(), o = p.oStart, e = p.oEnd, m, f, j;
...
nhn.husky.SE_PasteHandler = jindo.$Class({
    ...
    _filterPastedContents: function(V, C) {
        ...
        var ak = false
          ...
          , aa = 0
          , N = false;
        var s, g, f = [], ad = -1, p, am = "", an = ["BLOCKQUOTE", "DD", "DIV", "DL", "FORM", "H1", "H2", "H3", "H4", "H5", "H6", "HR", "OL", "P", "TABLE", "UL", "IFRAME"], Q = new RegExp("^(" + an.join("|") + ")$","i"), B = false, ah = 0, L = 0, O = [], y = 0;
        var ai = 0;
        var J = [];
        ...
        if (c.tagName === "LI") {
            if (c.previousSibling && c.previousSibling.tagName && c.previousSibling.tagName === c.parentNode.tagName) {
                if (c.nextSibling && c.nextSibling.tagName && c.nextSibling.tagName === c.parentNode.tagName) {
                    g = [c];
                    for (d = 0,
                    e = c.nextSibling.childNodes.length; d < e; d++) {
...
nhn.husky.SE2M_FontNameWithLayerUI = jindo.$Class({
    ...
    addAllFonts: function() {
        ...
        if (!!this.aAdditionalFontList && this.aAdditionalFontList.length > 0) {
            for (c = 0,
            nLen = this.aAdditionalFontList.length; c < nLen; c++) {
    ...
    _loadAllBaseFont: function() {
        ...
        if (this.htBrowser.nativeVersion < 9) {
            for (b = 0,
            a = this.aBaseFontList.length; b < a; b++) {
...
nhn.husky.SE2M_Quote = jindo.$Class({
    ...
    _isBlankQuote: function(c) {
        var n, f, g, m, l = this.oApp.oNavigator.chrome, d = this.oApp.oNavigator.safari, a = function(o) {
...
nhn.husky.SE_UndoRedo = jindo.$Class({
    ...
    _getParentXPath: function(d, e, p) {
        var n = this.sDefaultXPath, k, g, l, f, c, j, h = ["", "HTML[0]", "BODY[0]"], o = 0, m = -1, b, a;
        if (!d) {
            return n
        }
...
nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_TableEditor, {
    ...
    _isOnBorder: function(e) {
        ...
        nRightBorderCriteria = c - this.htResizing.htEPos.offsetX,
        nBottomBorderCriteria = a - this.htResizing.htEPos.offsetY;
    ...
    _getCellMapping: function(u) {
        ...
        var b = false;
        var v = null ;
        for (var h = 0, s = 0, d = r[0].length; h < d; h++,
        s++) {
            v = null ;
